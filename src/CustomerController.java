        ...
        while(true){
            ...
            switch (select) {
                ...
                case "3":
                    ...
                    System.out.println(success ? "Customer updated successfully!" : "Could not update customer, input a valid customer id.");
                case "4":
                    ...
                    System.out.println(addSuccess ? name + " successfully added to our customers list!" : "Customer could not be added, make sure you have added a valid name, email and password.");
                case "5":
                    System.out.println("Give id: ");
                    int deleteId = Integer.valueOf(scanner.nextLine());
                    boolean deleteSuccess = customerRepository.deleteCustomer(deleteId);
                    System.out.println(deleteSuccess ? "Customer deleted successfully" : "Customer could not be found, input a valid customer id.");
            }
        }
